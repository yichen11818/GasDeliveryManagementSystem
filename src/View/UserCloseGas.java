...
public class UserCloseGas {
	...
	protected JPanel addPanel1() {
		...
		}	//"序号", "ISBN", "书名", "图书类型", "作者", "借阅时间", "应还时间", "实际归还时间"
		Object[] columnChose = { "序号", "煤气名","煤气类型", "供应商名", "使用起始时间", "使用结束时间", "实际使用时间" };
		try {
				...
				if (chose_id != -1) {
					...
					if (c == JOptionPane.YES_OPTION) {
						...
						try {
							...
							JOptionPane.showMessageDialog(null, "您已经成功归还《" + getChoseName + "》", "操作成功",
