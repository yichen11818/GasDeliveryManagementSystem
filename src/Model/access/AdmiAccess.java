...
public class AdmiAccess {
	...
	public boolean queryAdmi(String count, String password) throws SQLException {
		String sql = "SELECT adm_count,adm_password FROM gasdms.administrator WHERE adm_count=? AND adm_password=?";
	...
	public Vector<Vector<Object>> queryAdmi(String count) throws SQLException {
		String sql = "SELECT adm_count,adm_name,adm_id_number,adm_tele,adm_email FROM gasdms.administrator WHERE adm_count=? AND issuper='0';";
	...
	public Vector<Vector<Object>> seleAdmi() throws SQLException {
		String sql = "SELECT adm_count,adm_name,adm_id_number,adm_tele,adm_email FROM gasdms.administrator WHERE issuper='0';";
	...
	public void deleAdmi(String superNumber) throws SQLException {
		String sql = "DELETE FROM gasdms.administrator WHERE adm_count=?";
	...
	public void updateAdmi(String adm_tele, String adm_email, String superNumber) throws SQLException {
		String sql = "UPDATE gasdms.administrator SET adm_tele=?,adm_email=? WHERE adm_count=?";
	...
	public void insterAdmi(String adm_count, String adm_name, String adm_id_number, String adm_tele, String adm_email,
		...
		String sql = "INSERT INTO gasdms.administrator(adm_count,adm_name,adm_id_number,adm_tele,adm_email,adm_keeppass,adm_password,issuper) VALUES(?,?,?,?,?,?,?,'0')";
	...
	public void updateAdmiPass(String alterPass, String adm_count, String adm_password, String adm_keeppass)
			throws SQLException {
		String sql = "UPDATE gasdms.administrator SET adm_password='" + alterPass
	...
	public boolean proveSuper(String count, String password) throws SQLException {
		String sql = "SELECT adm_count,adm_password FROM gasdms.administrator WHERE adm_count=? AND adm_password=? AND issuper='1'";
		return Connect.exist(sql, count,password);
	}
}
