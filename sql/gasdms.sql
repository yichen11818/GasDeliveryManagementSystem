...
--
-- Host: localhost    Database: gasdms
-- ------------------------------------------------------
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gas` (
  `g_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '煤气id',
  `ISBN` char(10) NOT NULL COMMENT 'ISBN',
  `g_name` varchar(45) NOT NULL COMMENT '煤气名',
  `gastype` int(11) unsigned NOT NULL COMMENT '煤气类型',
...
) ENGINE=InnoDB AUTO_INCREMENT=125 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='煤气信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `gastype` (
  `bt_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '煤气类型id',
  `bt_name` varchar(45) NOT NULL COMMENT '煤气类型',
  PRIMARY KEY (`bt_id`)
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='煤气类型信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `chose`
--
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `chose` (
  `Chose_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '使用信息id',
  `r_number` varchar(32) NOT NULL COMMENT '账号',
  `Chose_b_id` int(11) unsigned NOT NULL COMMENT '煤气id',
  `Chosedate` int(10) unsigned NOT NULL COMMENT '使用日期',
...
CREATE TABLE `user` (
  ...
  `user_community` int(11) unsigned NOT NULL COMMENT '用户类型',
  PRIMARY KEY (`number`),
...
INSERT INTO `user` VALUES ('20170744212','查询','男','信息工程学院','信工172','13569699696','464645646@qq.com','2019-02-20 08:27:23','e10adc3949ba59abbe56e057f20f883e','数据库',1),('20170744213','小黄','男','动物科技学院','动药172','13698987878','565646468965@qq.com','2019-02-20 11:20:24','e10adc3949ba59abbe56e057f20f883e','123',2),('20170744216','胡歌','男','生命科技学院','生科184','13569694848','346464646@qq.com','2019-02-21 00:42:01','e10adc3949ba59abbe56e057f20f883e','123',1),('20170744217','小韦','男','园艺园林学院','园林182','13256569898','5646476@qq.com','2019-02-20 13:38:34','e10adc3949ba59abbe56e057f20f883e','123',2),('20170744219','日上午','男','啊','叫你','15698984545','1593578885@qq.com','2019-02-21 13:02:55','e10adc3949ba59abbe56e057f20f883e','5',1),('20170744220','擦什','男','查数据库','陈铭','15678874554','1487660836@qq.com','2019-08-05 12:45:05','36e1a5072c78359066ed7715f5ff3da8','1',1),('20170744236','奥斯卡','男','擦看来','擦2','15639398989','634624641@qq.com','2019-02-21 06:22:11','e10adc3949ba59abbe56e057f20f883e','5',1),('20170744321','发生的','男','都是','考虑买','15968689898','4645654@qq.com','2019-02-22 12:17:44','e10adc3949ba59abbe56e057f20f883e','123',2);
...
CREATE TABLE `readertype` (
  `u_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '用户类型id',
  `u_community` varchar(30) NOT NULL COMMENT '用户类型',
  `maxcount` int(11) unsigned NOT NULL COMMENT '最大使用数量',
  `nowcount` int(11) unsigned NOT NULL COMMENT '最大使用天数',
  PRIMARY KEY (`u_id`),
  UNIQUE KEY `rt_name_UNIQUE` (`u_community`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户类型信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
