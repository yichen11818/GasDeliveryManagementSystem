...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gas` (
  `g_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '图书id',
  `ISBN` char(10) NOT NULL COMMENT 'ISBN',
  `g_name` varchar(45) NOT NULL COMMENT '书名',
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `chose` (
  `Chose_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '借阅信息id',
  `r_number` varchar(32) NOT NULL COMMENT '账号',
  `Chose_b_id` int(11) unsigned NOT NULL COMMENT '图书id',
  `Chosedate` int(10) unsigned NOT NULL COMMENT '借阅日期',
